# encoding: utf-8
class TipoMotor < ActiveRecord::Base
  
  self.table_name = 'tipo_motor' 
...
#    :too_short => "#{I18n.t('Sistema.Body.Vistas.General.tipo')} es demasiado corto (mínimo %{count})",
#    :too_long => " #{I18n.t('Sistema.Body.Vistas.General.tipo')} es demasiado largo (máximo %{count})"
...
#    :message => I18n.t('Sistema.Body.Vistas.General.tipo')
#  
