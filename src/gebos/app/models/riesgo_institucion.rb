...
#
# autor: Diego Bertaso
# clase: RiesgoInstitucion
# descripción: Migración a Rails 3
#

class RiesgoInstitucion < ActiveRecord::Base

  self.table_name = 'riesgo_institucion'
  ...
  def validate
    ...
    if self.porcentaje_riesgo < 0
      errors.add(:riesgo_institucion, "#{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Columnas.porcentaje_riesgo')} #{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Errores.mayor_igual_cero')}")
    end
    if self.porcentaje_riesgo > 100
      errors.add(:riesgo_institucion,"#{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Columnas.porcentaje_riesgo')} #{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Errores.menor_que_100')}")
    end
    if self.dias_vencidos_cota_inferior < 0
      errors.add(:riesgo_institucion,"#{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Columnas.dias_vencidos_cota_inferior')} #{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Errores.mayor_igual_cero')}")
    end

    if self.dias_vencidos_cota_superior < 1
      errors.add(:riesgo_institucion,"#{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Columnas.dias_vencidos_cota_superior')} #{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Errores.debe_ser_mayor_que_cero')}")
    end

    if self.dias_vencidos_cota_superior <= self.dias_vencidos_cota_inferior
      errors.add(:riesgo_institucion,"#{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Columnas.dias_vencidos_cota_superior')} #{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Errores.debe_ser_mayor')} #{I18n.t('Sistema.Body.Modelos.RiesgoInstitucion.Columnas.dias_vencidos_cota_inferior')}")
    end
