...
#
# autor: Diego Bertaso
# clase: AcumuladoEntidadFinanciera
# descripción: Migración a Rails 3
#

class AcumuladoEntidadFinanciera < ActiveRecord::Base

  self.table_name = 'acumulado_entidad_financiera'
...
# == Schema Information
#
# Table name: acumulado_entidad_financiera
#
#  id                    :integer         not null
