...
#
# autor: Luis Rojas
# clase: Prestamos::ReporteRendicionesPorTrimestreController
# descripción: Migración a Rails 3

class Prestamos::ReporteRendicionesPorTrimestreController < FormClassicController
 ...
 #include RjReport
  ...
  def procesar_reporte
    ...
    conditions = "fecha_liquidacion >= \'#{fecha_inicio}\' and fecha_liquidacion <= \'#{fecha_fin}\'"
    ...
    logger.info "Sub Rubros =============> #{params[:sub_rubros_id]}"
    sub_rubros_id = params[:sub_rubros_id]
    unless params[:sub_rubros_id][0].blank?
    ...
    file_name = "rendiciones_por_trimestre_del_#{fecha_inicio_rep}_al_#{fecha_fin_rep}.xls"
    nombre_archivo = ViewCreditosLiquidados.exportar_excel(conditions, file_name, fecha_inicio_rep1, fecha_fin_rep1)
    archivo_salida = 'rendiciones_por_trimestre'
    ...
    #@reporte = 'financiamientos_rendiciones_por_trimestre'
  ...
  def common
    super
    @form_title = 'Reporte Rendiciones Por Trimestre'
