...
class Prestamos::ReporteAnalisisEjecucionController < FormClassicController
 ...
 #include RjReport
  ...
  def procesar_reporte
    ...
    file_name = "analisis_ejecucion_cartera_del_#{fecha_inicio_rep}_al_#{fecha_fin_rep}.xls"
    nombre_archivo = ViewFinanciadoRecuperado.exportar_excel(conditions, file_name, fecha_inicio_rep1, fecha_fin_rep1)
  ...
  def common
    super
    @form_title = 'Reporte Análisis de Ejecución (Aprobado Versus Liquidado)'
