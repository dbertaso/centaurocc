...
class FormVisitasAjaxController < FormController

  helper :form_ajax
  layout 'form_visitas_ajax'
  
   skip_before_filter :set_charset, :only=>[:edit, :cancel_edit, :new, :save_new, :save_edit, :cancel_new, :list, :delete, :form_error, :errors_for, :error, :form_save_new, :form_save_ajaxnew, :form_save_ajaxedit, :form_new]
