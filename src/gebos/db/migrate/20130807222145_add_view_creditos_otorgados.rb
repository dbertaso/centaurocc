...
class AddViewCreditosOtorgados < ActiveRecord::Migration
  def up
    ...
    execute "
        ...
        CREATE OR REPLACE VIEW view_creditos_otorgados AS 
         SELECT solicitud.id AS solicitud_id, solicitud.fecha_aprobacion, solicitud.sector_id, solicitud.sub_sector_id, solicitud.rubro_id, solicitud.sub_rubro_id, sub_rubro.nombre AS sub_rubro_nombre, 
                CASE
