-- Function: generar_plan_pago_evento(p_proyectado bool, p_prestamo_id int4, p_fecha_evento date, p_tiene_desembolso bool, p_monto_desembolso float8, p_tiene_tasa bool, p_valor_tasa float8, p_tiene_abono bool, p_monto_abono float8, p_desembolso_id int4, p_extension_meses_muertos int4)

-- DROP FUNCTION generar_plan_pago_evento(p_proyectado bool, p_prestamo_id int4, p_fecha_evento date, p_tiene_desembolso bool, p_monto_desembolso float8, p_tiene_tasa bool, p_valor_tasa float8, p_tiene_abono bool, p_monto_abono float8, p_desembolso_id int4, p_extension_meses_muertos int4);

CREATE OR REPLACE FUNCTION generar_plan_pago_evento(p_proyectado bool, p_prestamo_id int4, p_fecha_evento date, p_tiene_desembolso bool, p_monto_desembolso float8, p_tiene_tasa bool, p_valor_tasa float8, p_tiene_abono bool, p_monto_abono float8, p_desembolso_id int4, p_extension_meses_muertos int4)
  RETURNS bool AS
$BODY$
 ...
 -- Inicio Contabilidad 
   ...
   select into _plan_pago_cuota * from plan_pago_cuota
     ...
     where fecha >= p_fecha_evento and plan_pago_id = _plan_pago.id order by fecha asc limit 1;   _fecha_focal = _plan_pago_cuota.fecha;
   ...
   raise notice 'PARAMETRO PLAZO ENVIADO________________________%',_plan_pago.plazo;
  ...
  -- Recupera las cuotas a clonar  
   ...
   _plazo = _plan_pago.plazo;
	...
	raise notice 'PLAZO DESPUES DEL CURVAL__________________________%', _plazo;
   ...
   loop
	...
	raise notice 'PLAZO DESPUES DE RESTAR FRECUENCIA DE PAGO__________________________%', _plazo;
  ...
  raise notice 'MESES_MUERTOS__________________________%', _meses_muertos;
	raise notice 'PLAZO plan_pago_evento__________________________%', _plazo;
...
ALTER FUNCTION generar_plan_pago_evento(p_proyectado bool, p_prestamo_id int4, p_fecha_evento date, p_tiene_desembolso bool, p_monto_desembolso float8, p_tiene_tasa bool, p_valor_tasa float8, p_tiene_abono bool, p_monto_abono float8, p_desembolso_id int4, p_extension_meses_muertos int4) OWNER TO cartera;
