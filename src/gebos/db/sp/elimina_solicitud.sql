...
begin
	...
	*/
	...
	if found then
		...
		*/
		...
		if found then
			...
			if found then
				...
				loop
					...
					*/
					...
					SELECT setval('resultado_cualitativa_id_seq', 1);
				end loop;
			...
			*/
			...
			SELECT setval('evaluacion_analisis_costos_id_seq', 1);
			...
			*/
			...
			SELECT setval('evaluacion_cualitativa_id_seq', 1);
				...
				*/
				...
				loop
					...
					*/
					...
					SELECT setval('evaluacion_flujo_caja_detalle_id_seq', 1);
			...
			*/
			...
			SELECT setval('evaluacion_flujo_caja_id_seq', 1);
			...
			*/
			...
			SELECT setval('evaluacion_plan_inversion_id_seq', 1);
		...
		*/
		...
		loop
			...
			*/
			...
			SELECT setval('garantia_id_seq', 1);
		...
		*/
		...
		loop
			...
			*/
			...
			select setval('solicitud_evento_id_seq', 1);
		...
		*/
		...
		select setval('solicitud_capacidad_id_seq', 1);
		...
		*/
		...
		select setval('solicitud_historico_id_seq', 1);
		...
		*/
		...
		select setval('solicitud_recaudo_id_seq', 1);
		...
		*/
		...
		select setval('evaluacion_id_seq', 1);
	...
	*/
	...
	select setval('solicitud_id_seq', 1);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION eliminasolicitud(bigint) OWNER TO gprotec;
