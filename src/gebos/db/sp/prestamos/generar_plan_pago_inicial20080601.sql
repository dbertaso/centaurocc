-- Function: generar_plan_pago(boolean, integer, integer, integer, integer, bpchar, double precision, double precision, date, double precision, integer, integer, double precision, integer, integer, integer, boolean, double precision, integer, integer, boolean, date, double precision)

-- DROP FUNCTION generar_plan_pago(boolean, integer, integer, integer, integer, bpchar, double precision, double precision, date, double precision, integer, integer, double precision, integer, integer, integer, boolean, double precision, integer, integer, boolean, date, double precision);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION generar_plan_pago(boolean, integer, integer, integer, integer, bpchar, double precision, double precision, date, double precision, integer, integer, double precision, integer, integer, integer, boolean, double precision, integer, integer, boolean, date, double precision) OWNER TO cartera;
