...
$BODY$
  ...
  begin
   ...
   -- end if;
    ...
    --_pago_monto_prestamo  < _prestamo.exigible then
      ...
      if p_fecha_realizacion < p_fecha and
        ...
        perform calcular_interes_causado(_prestamo.id, _fecha_calculo, false);
      end if;
      ...
      */
      ...
      /*
      -----------------------------------------
      Creación de cursor de cuotas exigible
      -----------------------------------------
      */
      ...
      if _cantidad_cuotas_exigibles = 0 and
         _prestamo.causado_no_devengado > 0 and
         _remanente_por_aplicar > 0 then

        _deuda_interes_corriente = _prestamo.causado_no_devengado;

        raise notice 'Plan pago id ===========================> %', _plan_pago.id;
        raise notice 'Deuda Interes ==========================> %', _deuda_interes_corriente;
        ...
        */
        ...
        if  _deuda_interes_corriente > 0 then
    ...
    _pago_cuota_total = _pago_real_interes_diferido +
      ...
      raise notice 'Remanente por Aplicar =======> En vigente %, % ', _remanente_por_aplicar, _plan_pago_cuota.id;
      ...
      _pago_cuota_id = currval('pago_cuota_id_seq');
      raise notice 'Plan Pago cuota id =======> En vigente %', _pago_cuota_id;
      ...
      _con_monto_intereses_por_cobrar = _con_monto_intereses_por_cobrar + _plan_pago_cuota.intereses_por_cobrar_al_30;
       ...
       _plan_pago_cuota = null;

      end if;   -- if _cantidad_cuotas_exigibles = 0 and
                -- _prestamo.causado_no_devengado > 0 and
                -- _remanente_por_aplicar > 0 then
      ...
      */
      ...
      /*
      if _prestamo.frecuencia_pago = 0 and
      ...
      */
      ...
      RAISE NOTICE 'Estatus despues de cuotas vencidas ==========> % ', _estatus;
   ...
   if p_cancelacion_prestamo = false then
    ...
    raise notice '____________________saldo insoluto %', _prestamo.saldo_insoluto;
