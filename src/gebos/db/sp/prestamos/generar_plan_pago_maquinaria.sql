-- Function: generar_plan_pago_maquinaria(boolean, integer, integer, integer, integer, character, double precision, double precision, date, double precision, integer, integer, double precision, integer, integer, integer, boolean, double precision, integer, integer, boolean, date, double precision)

-- DROP FUNCTION generar_plan_pago_maquinaria(boolean, integer, integer, integer, integer, character, double precision, double precision, date, double precision, integer, integer, double precision, integer, integer, integer, boolean, double precision, integer, integer, boolean, date, double precision);

CREATE OR REPLACE FUNCTION generar_plan_pago_maquinaria(p_proyectado boolean,
                                                       ...
                                                       p_monto_diferido double precision,
...
$BODY$
  ...
  declare
    ...
    _monto_diferido decimal(16,2);
    _fuente_recursos_id integer = 1;
    ...
    --Variables Para el 365
     ...
     begin
       ...
       _monto_transaccion = _prestamo.monto_inventario;
       ...
       _mes = extract(month from _fecha_inicio);
       ...
       if p_desembolso_id <> 0 then
        ...
        begin
          ...
          end if;   ----> Fin if p_plan_pago_id = 0 then
          ...
          for i in 1..p_meses_muertos loop
            ...
            */
            ...
            _monto_diferido = _total_interes_gracia_diferido / _cantidad_cuotas;
        ...
        values
                       (
                         ...
                         'M',
                         p_prestamo_id,
                         _prestamo.monto_banco,
                         _prestamo.monto_insumos,
                         _prestamo.monto_sras_total,
                         _prestamo.monto_inventario,
        ...
        */
        ...
        perform registro_contable (20,
                                   ...
                                   'V',
                                   0,
                                   cast(_monto_transaccion as float),
                                   0,
                                   0,
                                   0,
                                   0,
