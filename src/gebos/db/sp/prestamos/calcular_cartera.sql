-- Function: calcular_cartera(p_fecha date, p_oficina_id int4)

-- DROP FUNCTION calcular_cartera(p_fecha date, p_oficina_id int4);

CREATE OR REPLACE FUNCTION calcular_cartera(p_fecha date, p_oficina_id int4)
  RETURNS bool AS
$BODY$
declare
...
ALTER FUNCTION calcular_cartera(p_fecha date, p_oficina_id int4) OWNER TO cartera;
