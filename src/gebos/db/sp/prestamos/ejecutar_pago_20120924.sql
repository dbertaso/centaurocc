...
$BODY$
  ...
  begin
    ...
    _interes_causado_pagado = _prestamo.interes_causado_no_devengado;
    ...
    into 
            pago_cliente 
                ( fecha, modalidad, monto, cliente_id, oficina_id, 
                  fecha_realizacion, numero_voucher, entidad_financiera_id, efectivo)

      values 
                ( p_fecha, p_modalidad, p_monto, p_cliente_id, p_oficina_id, 
                  p_fecha_realizacion, p_numero_voucher, p_entidad_financiera_id, p_monto_efectivo);
    ...
    */
    ...
    if not found and 
       ...
       _interes_causado_pagado > 0 then
       
       if _remanente_por_aplicar >= _interes_causado_pagado then
       
         _interes_causado_pagado = _remanente_por_aplicar - _interes_causado_pagado;
         _remanente_por_aplicar = _remanente_por_aplicar - _interes_causado_pagado;
      
       else
          _interes_causado_pagado = _interes_causado_pagado - _remanente_por_aplicar;
