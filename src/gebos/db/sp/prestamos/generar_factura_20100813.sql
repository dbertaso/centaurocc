CREATE OR REPLACE FUNCTION generar_factura(p_numero integer, p_monto_factura numeric(14,2), p_fecha date,
                 ...
                 p_consultoria_juridica boolean, p_abono_capital numeric(14,2), p_recuperaciones boolean) RETURNS boolean AS
$body$
declare
...
begin
  ...
  */
       ...
       insert into factura (numero, monto, fecha, fecha_realizacion, pago_cliente_id, tipo,
                             ...
                             consultoria_juridica, abono_capital, recuperaciones)
        values (p_numero, p_monto_factura, p_fecha,
                 ...
                 p_consultoria_juridica, p_abono_capital, p_recuperaciones) ;
