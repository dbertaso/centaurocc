-- Function: aprobacion_comite_estadal()

-- DROP FUNCTION aprobacion_comite_estadal();

CREATE OR REPLACE FUNCTION aprobacion_comite_estadal( p_solicitudes character varying[],
                                                        p_hay_items boolean,
...
declare
  ...
  _solicitud_monto_aprobado numeric(16,2) = 0;
  _result integer = 0;
  ...
  if p_hay_items = true then
    ...
    for i in array_lower(p_solicitudes,1)..array_upper(p_solicitudes,1) 
      loop
           ...
           raise info 'Solicitud id ==========> %', _solicitud_id;
          ...
          if found then
            ...
            raise notice 'Encontró la solicitud';
            ...
            */
            ...
            select 
            into
                    _configuracion_avance *
            from
                    configuracion_avance
            where
                    estatus_origen_id = _estatus_id_inicial;
                    
            if not found then
              return 2;         -- No existe registro en tabla configuración avance
            end if;
            
            if p_tipo_decision = 'A' then
            
              if _solicitud.monto_solicitado > _parametro.banda_inferior_comite_credito then
              
                _estatus_id_final = _configuracion_avance.estatus_destino_id;   -- 10034
              else
              ...
              */
              ...
              perform generar_compromiso(_solicitud.id, 'C');
              
            end if;
            
            if p_tipo_decision = 'R' then
            
              _estatus_id_final = 10024;
              ...
              if _solicitud.por_inventario = true then
                ...
                */
                ...
                if not found then
                  ...
                  raise notice 'No encontró el registro del pidan';
                end if;
            ...
            */
            ...
            update
                    solicitud
            set
                    decision_comite_estadal = p_tipo_decision,
                    comentario_comite_estadal = p_comentario,
            ...
            */
            ...
            where
                  ...
                  comite_id = _solicitud.comite_estadal_id;
