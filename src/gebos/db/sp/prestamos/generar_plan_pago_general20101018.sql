...
begin
  ...
  if p_frecuencia_pago = 0 then
    p_frecuencia_pago = p_meses_gracia;
  end if;
  ...
  for i in 1.._cantidad_cuotas loop
    ...
    values(
      ...
      'G',0,p_tasa_valor_gracia,'X',_cantidad_dias, _fecha_cuota);
