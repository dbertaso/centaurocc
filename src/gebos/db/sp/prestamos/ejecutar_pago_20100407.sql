    ...
    --_pago_monto_prestamo  < _prestamo.exigible then
      ...
      loop
            ...
            */
            ...
            if _pago_incompleto = false and _deuda_interes_diferido > 0 and p_proceso_nocturno = false then
            ...
            */
            ...
            if _remanente_por_aplicar <= _plan_pago_cuota.saldo_insoluto then
              ...
              */
              ...
              /*
              ----------------------------------------
              Se marcan como pagadas las cuotas no
              exigibles si el prestamo esta cancalado
              ----------------------------------------
              */
