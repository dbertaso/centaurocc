-- Function: calcular_cartera_prestamo(date, integer, integer, integer)

-- DROP FUNCTION calcular_cartera_prestamo(date, integer, integer, integer);
    ...
    begin
      ...
      */
      ...
      loop
        ...
        --Actualización de los indicadores de cobranzas

        perform actualizacion_indicadores_cobranzas(_prestamo.id, p_fecha);
      ...
      */
      ...
      open 
                ...
                */
                ...
                if _tiene_tasa = true then
                  ...
                  perform generar_plan_pago_evento( false, 
                                                    ...
                                                    _valor_tasa, 
                                                    _tiene_abono, 
                                                    _prestamo.remanente_por_aplicar,
                                                    0,
                                                    0,
		...
		raise notice 'Ultimo prestamo en control_cierre -------> %', p_ultimo;
		raise notice 'Ultimo id de la tabla préstamo    -------> %', _prestamo.id;
