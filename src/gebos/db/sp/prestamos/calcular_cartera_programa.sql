-- Function: calcular_cartera_programa(p_fecha date, p_oficina_id int4, p_programa_id int4)

-- DROP FUNCTION calcular_cartera_programa(p_fecha date, p_oficina_id int4, p_programa_id int4);

CREATE OR REPLACE FUNCTION calcular_cartera_programa(p_fecha date, p_oficina_id int4, p_programa_id int4)
  RETURNS bool AS
$BODY$
declare
...
ALTER FUNCTION calcular_cartera_programa(p_fecha date, p_oficina_id int4, p_programa_id int4) OWNER TO cartera;
