-- Function: cancelar_prestamo(p_cliente_id integer, p_prestamo_id integer, p_cheques character varying[], p_modalidad bpchar, p_monto double precision, p_oficina_id integer, p_fecha_contabilizacion date, p_fecha_realizacion date)

-- DROP FUNCTION cancelar_prestamo(p_cliente_id integer, p_prestamo_id integer, p_cheques character varying[], p_modalidad bpchar, p_monto double precision, p_oficina_id integer, p_fecha_contabilizacion date, p_fecha_realizacion date);

CREATE OR REPLACE FUNCTION cancelar_prestamo(p_cliente_id integer, p_prestamo_id integer, p_cheques character varying[], p_modalidad bpchar, p_monto double precision, p_oficina_id integer, p_fecha_contabilizacion date, p_fecha_realizacion date)
  RETURNS boolean AS
$BODY$
 	   ...
 	   open _cur_plan_pago_cuota for select * from plan_pago_cuota inner join plan_pago
         ...
         loop
 		    ...
 		    if _con_pago_cuota.dias_mora=0 then
 			   ...
 			   _con_ingreso_intereses = _con_ingreso_intereses + (_con_pago_cuota.pago_interes_corriente - _con_pago_cuota.intereses_por_cobrar_al_30) + pago_interes_diferido;			
...
ALTER FUNCTION cancelar_prestamo(p_cliente_id integer, p_prestamo_id integer, p_cheques character varying[], p_modalidad bpchar, p_monto double precision, p_oficina_id integer, p_fecha_contabilizacion date, p_fecha_realizacion date) OWNER TO cartera;
