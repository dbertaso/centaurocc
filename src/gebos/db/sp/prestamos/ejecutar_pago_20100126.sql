...
$BODY$
					  ...
					  _sector_economico = (SELECT get_datos_cliente(_prestamo.cliente_id, 'sector_economico'));
 					  ...
 					  _distincion_cobranza = (SELECT get_tipo_pago(_pago_cliente_id));
                                          ...
                                          insert into factura (numero, monto, fecha, fecha_realizacion, pago_cliente_id, tipo, proceso_nocturno, prestamo_id, remanente_por_aplicar, tipo_cartera, codigo_contable, sector_economico, estado, comentario_analista, distincion_cobranza, analista, consultoria_juridica)
                                            values ((select ultima_factura from parametro_general) + 1, _monto_factura, p_fecha,
                                            p_fecha_realizacion, _pago_cliente_id, 'P', p_proceso_nocturno, _prestamo_id, _remanente_por_aplicar, _prestamo.banco_origen, _prestamo.codigo_contable, _sector_economico, _estado_prestamo, p_observaciones_analista, _distincion_cobranza, _analista, p_consultoria_juridica ) ;
