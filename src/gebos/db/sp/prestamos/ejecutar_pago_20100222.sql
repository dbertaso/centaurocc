...
$BODY$
  ...
  begin
   ...
   -- end if;
    ...
    --_pago_monto_prestamo  < _prestamo.exigible then
      ...
      loop
            ...
            if _prestamo.estatus in ('V','H') then
   ...
   raise notice 'Prestamo Estatus   %, % ', _estatus, _prestamo.estatus;
...
ALTER FUNCTION ejecutar_pago(integer, character varying[], integer, character, double precision, integer, date, date, character varying, double precision, integer, boolean, boolean, boolean, boolean, boolean, character varying, character varying) OWNER TO cartera;
