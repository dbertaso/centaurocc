create or replace function generar_plan_pago(
  p_proyectado bool,
  p_formula_id integer,
  p_prestamo_id integer,
  p_plan_pago_id integer,
  p_numero_cuota_inicial integer,
  p_tipo_cuota_inicial char,
  p_interes_acumulado_inicial float,
  p_amortizado_acumulado_inicial float,
  ...
  p_exonerar_intereses_diferidos bool,
  ...
  p_interes_diferido numeric(16,2) ) returns bool as $$
declare  
...
begin
  ...
  -- Genera las cuotas del período muerto
  ...
  -- Genera las cuotas del período de gracia
