			...
			--_pago_interes_mora_aux = _pago_interes_mora;
				if _remanente_por_aplicar >= _deuda_interes_mora then
					...
					*/
					...
					insert into plan_pago_mora(plan_pago_cuota_id, tasa_valor, fecha_inicio, fecha_fin, capital) values(_plan_pago_cuota.id, 0, p_fecha_realizacion, p_fecha_realizacion, 0);  
