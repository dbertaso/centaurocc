                  ...
                  for i in 1.._cantidad_cuotas loop
                   ...
                   if _programa.ultimo_desembolso = 1 or
                    ...
                    if _programa.tipo_diferimiento = true then
                       ...
                       raise notice 'Entro por programa tipo de diferimiento ===========================>';
                       raise notice '===================================================================>';

                       _interes_diferido = (_programa.porcentaje_diferimiento * _interes_cuota) / 100;

                       if _interes_cuota = _interes_diferido then
