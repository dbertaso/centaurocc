...
$BODY$
                    ...
                    begin
                      ...
                      raise info '[GEBOS] calcular_cartera_programa {p_fecha: %, p_oficina_id: %, p_programa_id: %', p_fecha, p_oficina_id, p_programa_id;
                      ...
                      */
                      open _cur_prestamo for select * from
                        ...
                        where prestamo.estatus not in ('S', 'L', 'Q', 'R', 'C', 'F', 'A', 'X','K') order by prestamo.numero;
